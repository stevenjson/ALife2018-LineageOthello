...
EMP_BUILD_CONFIG( LineageConfig,
  ...
  VALUE(RESOURCE_SELECT__RES_AMOUNT, double, 100.0, ".."),
  VALUE(RESOURCE_SELECT__RES_INFLOW, double, 100.0, ".."),
  VALUE(RESOURCE_SELECT__OUTFLOW, double, 0.05, ".."),
  VALUE(RESOURCE_SELECT__FRAC, double, 0.0025, ".."),
  VALUE(RESOURCE_SELECT__MAX_BONUS, double, 5.0, ".."),
  VALUE(RESOURCE_SELECT__COST, double, 0.0, ".."),
  VALUE(RESOURCE_SELECT__GAME_PHASE_LEN, size_t, 10, "..."),
